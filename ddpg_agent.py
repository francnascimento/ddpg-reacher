...
UPDATE_EVERY = 20       # number of steps to update
NUM_UPDATE = 10         # number of updates
...
class Agent():
    ...
    def __init__(self, state_size, action_size, fc1_units, fc2_units, batch_size, random_seed):
    ...
    def learn(self, experiences, gamma):
        ...
        # Minimize the loss
        # Using gradient clipping to the critic
